...
export class AppComponent {
  ...
  public cliente = {
    "client": "ASISTENCIA TECUI",
    "id_country": "MX",
    "img_cliente": "id_client5905d155780eb1c5.png",
    "web": "https://asistenciatecui.com",
    "urlPrueba": "https://asistenciatecui.com",
    "prefix": "TC",
    "type_platform": "1",
    "id_broker": "16",
    "email": "",
    "colors_platform": "{\n  \"COLOR_MENU_BACKEND\": \"#401f1f\",\n  \"color_tr_table\": \"#615c5c\",\n  \"color_font_tr\": \"#ffffff\",\n  \"color_login\": \"#f6f6f6\",\n  \"color_menu\": \"#f0f0f0\",\n  \"color_menu_barra\": \"#743838\",\n  \"color_menu_barra_hover\": \"#af5d56\",\n  \"color_font_tab\": \"#363636\",\n  \"color_email_font\": \"#f6f6f6\",\n  \"email_shadow_table\": \"#f9f9f9\"\n}"
  };
  ...
  constructor(public platform: Platform,
    ...
    network.onConnect().subscribe(() => {
      ...
      this.userType ? this.navCtrl.navigateRoot('/list-orders') : navCtrl.navigateRoot('/login/TC');;
  ...
  sessionColores(colorsPlatform, cliente) {
    if (localStorage.getItem('paramAgency') != 'N/A' && localStorage.getItem('paramAgency')) {
      ...
      localStorage.setItem("nomClient", 'ASISTENCIA TECUI');
    }
  }
